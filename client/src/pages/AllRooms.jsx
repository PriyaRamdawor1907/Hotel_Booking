...
const AllRooms = () =>{
  ...
  return(
    ...
    pt-28 md:pt-35 px-4 md:px-16 lg:px-24">
      <div>
        <div className="flex flex-col items-start text-left">
          ...
          <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">
            Take advantage of our limited time offers and special packes to enhance your stay
          </p>
        </div>
      ...
      <div>
        <div className="bg-white w-60 border border-gray-300 text-gray-600
        max-lg:mb-8 min-lg:mt-16 rounded-2xl">
