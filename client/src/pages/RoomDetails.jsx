  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      mx-auto mt-16 max-w-6xl'>
        ...
        active:scale-95 transition-all text-white rounded-3xl max-md:w-full
        max-md:mt-6 md:px-25 py-2 md:py-4 text-base cursor-pointer'>
          Check Availability
        </button>
      </form>
      ...
      <div className='flex flex-col items-start gap-4 mt-20'>
        <div className='flex gap-4'>
          ...
          <div className='items-center mt-3'>
            <p className='text-lg md:text-xl'>Hosted by Priya Ramdawor</p>
          </div>
        </div>
      </div>

      <button className='px-6 py-2.5 mt-6 rounded-3xl text-white bg-primary hover:bg-teal-700
