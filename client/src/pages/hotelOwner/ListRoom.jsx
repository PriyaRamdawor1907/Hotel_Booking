...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      or manage all the listed rooms. Keep the information up-to-date to provide the
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="py-3 px-4 text-gray-800 font-medium text-center">Actions Status</th>
            </tr>
          </thead>
              ...
              <tr key={index}>
                ...
                text-red-500 text-center">
                  ...
                  text-gray-900 gap-3">
                    ...
                    <div className="w-12 h-7 bg-slate-300 rounded-full peer peer-checked:bg-teal-700 transition-colors duration-200">
