...
const AddRoom = () => {
  ...
  return (
    <form>
      ...
      details carefully and accurate room details, pricing, and amenities,
      ...
      <div className="gird grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
        {Object.keys(images).map((key) =>(
          <label htmlFor={`roomImage ${key}`} key={key}>
            <img className="max-h-13 cursor-pointer opacity-80 my-3 rounded-xl"
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        <div className="flex-1 max-w-48">
          ...
          className="border opacity-70 border-gray-300 mt-1 rounded p-2 w-full text-sm">
      ...
      <button className="bg-primary text-white px-8 py-2 rounded mt-8 cursor-pointer mb-20">
        Add Room
      </button>
